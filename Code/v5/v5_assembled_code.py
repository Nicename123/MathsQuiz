...
def age(): #To ask for user's age
    ...
    while True:
        ...
        if age.replace(' ','').isnumeric():
            ...
            print("You have entered an ivalid input")
age()

def inst(): #To ask if the user needs instructions
    inst = input("\nDo you know how to play the quiz? (Enter Yes Or No): \na. Yes \nb. No \n=>")
    if inst == 'Yes' or inst == 'yes' or inst == 'a' or inst == 'A' or inst == 'y' or inst == 'Y' or inst == 'YES' or inst == 'YEs' or inst == 'YeS' or inst == 'yES': #If user knows how to play
        print("********************************************************************************************************************")
    elif inst == 'No' or inst == 'no' or inst == 'b' or inst == 'B' or inst == 'n' or inst == 'N'or inst == 'nO' or inst == 'NO'or inst == 'nO': #If user does not know how to play
        print("**************************************************** INSTRUCTIONS ***************************************************")
