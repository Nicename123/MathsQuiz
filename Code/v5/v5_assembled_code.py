...
def inst():
    while True:
        ...
        if inst == 'Yes' or inst == 'yes' or inst == 'a' or inst == 'A' or inst == 'y' or inst == 'Y' or inst == 'YES' or inst == 'YEs' or inst == 'YeS' or inst == 'yES': 
            print("********************************************************************************************************************")
            break
        if inst == 'No' or inst == 'no' or inst == 'b' or inst == 'B' or inst == 'n' or inst == 'N'or inst == 'nO' or inst == 'NO'or inst == 'nO':
            print("**************************************************** INSTRUCTIONS ***************************************************")
            print("This is a multiple choice maths quiz")
...
def status():
    while True:
        ...
        if status == 'No' or status == 'no' or status == 'b' or status == 'B' or status == 'n' or status == 'N'or status == 'nO' or status == 'NO'or status == 'nO':
            print("See you later")
            exit()
            break
        if status == 'Yes' or status == 'yes' or status == 'a' or status == 'A' or status == 'y' or status == 'Y' or status == 'YES' or status == 'YEs' or status == 'YeS' or status == 'yES':
            print("**************************************************** WELCOME TO MATHS QUIZ ****************************************************")
            break
        else:
            print("Please enter yes or no")
