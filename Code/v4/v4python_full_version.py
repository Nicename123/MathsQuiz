...
def inst(): #To ask if the user needs instructions
    inst = input("\nDo you know how to play the quiz? (Enter Yes Or No): \na. Yes \nb. No \n=>")
    if inst == 'Yes' or inst == 'yes' or inst == 'a' or inst == 'A' or inst == 'y' or inst == 'Y': #If user knows how to play
        print("********************************************************************************************************************")
    elif inst == 'No' or inst == 'no' or inst == 'b' or inst == 'B' or inst == 'n' or inst == 'N': #If user does not know how to play
        print("**************************************************** INSTRUCTIONS ***************************************************")
        print("This is a multiple choice maths quiz") #The instructions
...
if status == 'No' or status == 'no' or status == 'b' or status == 'B' or status == 'n' or status == 'N'or status == 'nO' or status == 'NO': #If user is not ready
    print("See you later")
    exit()
    
#If user is ready
elif status == 'Yes' or status == 'yes' or status == 'a' or status == 'A' or status == 'y' or status == 'Y' or status == 'YES' or status == 'YEs' or status == 'YeS' or status == 'yES': #If user is ready
    print("**************************************************** WELCOME TO MATHS QUIZ ****************************************************")
